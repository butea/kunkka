...
//}
//
//func (c *cache) get(name string) (*registry.Service, error) {
//	// read lock
//	c.RLock()
//
//	// check the cache first
//	service := c.cache[name]
//	// get cache ttl
//	ttl := c.ttls[name]
//	// make a copy
...
//	}
//
//	service, ok := c.cache[res.Service.Name]
//	if !ok {
...
//	case "create", "update":
//		if service == nil {
//			c.set(res.Service.Name, res.Service)
//			return
//		}
//
